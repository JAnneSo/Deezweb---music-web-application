...
function createAlbumCard(objAlbum) {
    ...
    imgContainerElt.classList.add("album-card__img-ctnr");
...
function createTrackCard(objTrack) {
    ...
    imgContainerElt.classList.add("track-card__img-cntr");
    ...
    playBtnElt.setAttribute("onclick", "play(this)");
    playBtnElt.innerHTML = "<i class='fa fa-play'></i>";
    checkboxElt.setAttribute("type", "checkbox");
    checkboxElt.setAttribute("id", `ckbx_${objTrack.id}`); // à revoir
    checkboxElt.setAttribute("onclick", "storeFavorite(this)");
    loveBtnElt.setAttribute("for", `ckbx_${objTrack.id}`);
    loveBtnElt.setAttribute("id", `${objTrack.id}`);
...
function createArtistCard(objArtist) {
    ...
    imgContainerElt.classList.add("artist-card__img-ctnr");
    ...
    // saisie des attributs et text content
    linkElt.setAttribute("href", `pages/artiste.html?id=${objArtist.id}`);
    imgElt.setAttribute("src", objArtist.picture_medium);
    artisteElt.setAttribute("href", `pages/artiste.html?id=${objArtist.name}`);
